            ...
            <div className="space-y-2 mt-4">
              ...
              <div className="flex space-x-3 mt-3">
                {Array(4).fill(0).map((_, i) => (
                  <div key={i} className="w-8 h-8 rounded-full bg-[#2a2a2a]" />
                ))}
              </div>
            </div>
          </div>
            ...
            <div className="bg-[#1A1A1A] rounded-xl p-5">
              ...
              <div className="space-y-3">
                {achievements.slice(0, 2).map((achievement) => (
                  <div key={achievement.id} className="p-3 rounded-lg bg-[#0D0D0D]">
                    ...
                    <p className="text-right text-xs mt-1 text-[#F5F5F5]/60">{achievement.progress}% complete</p>
                  </div>
                ))}
              </div>
            </div>
        ...
        {activeTab === "notes" && (
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {userNotes.map((note) => (
                <div key={note.id} className="bg-[#1A1A1A] rounded-xl p-4 border border-[#F5F5F5]/5">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {userQuizzes.map((quiz) => (
                <div key={quiz.id} className="bg-[#1A1A1A] rounded-xl p-4 border border-[#F5F5F5]/5">
                  <div className="flex items-center justify-between mb-2">
              ...
              {achievements.map((achievement) => (
                <div key={achievement.id} className="p-4 rounded-lg bg-[#1A1A1A]">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                      <h3 className="font-medium">{achievement.title}</h3>
                      <p className="text-sm text-[#F5F5F5]/60">{achievement.description}</p>
                    </div>
                    <div className="ml-auto text-right">
                      <span className="text-lg font-bold" style={{ color: achievement.color }}>
